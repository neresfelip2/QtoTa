            ...
            Card(
                ...
                Column(Modifier.padding(8.dp)) {
                    ...
                    Row(
                        ...
                        product.previousValue?.let { previousValue ->
                            Row(Modifier.weight(1f),
                                ...
                                Text(
                                    "${calculateDiscount(product.currentValue, previousValue)}% OFF",
                                    Modifier
                                        .padding(4.dp)
                                        .background(
                                            shape = RoundedCornerShape(8.dp),
                    ...
                    Row(
                        ...
                        if((savedProducts.find { it.id == product.id }) == null) {
                            Button(
                                { onHighlightedButtonClick(product) },
                                Modifier.padding(4.dp),
...
private fun calculateDiscount(currentValue: Double, previousValue: Double): Int {
    return (100 - 100 * (currentValue / previousValue)).toInt()
}
